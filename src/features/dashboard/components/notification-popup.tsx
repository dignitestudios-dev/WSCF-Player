    ...
    <article className="flex items-start gap-3 rounded-xl py-[15px]">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-2.5">
        <div className="flex w-full min-w-0 items-center justify-between gap-2.5">
          <h3 className="min-w-0 flex-1 text-lg font-semibold leading-[21px] tracking-[-0.005em] text-[#083F92] break-words [overflow-wrap:anywhere]">
            {notification.title}
          </h3>
        ...
        <p className="text-sm font-medium leading-[19px] tracking-[-0.005em] text-[#121111] break-words [overflow-wrap:anywhere]">
